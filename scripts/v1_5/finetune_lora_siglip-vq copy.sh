...
deepspeed --master_port 29516 --include=localhost:5,6,7 /public_data/jihai/understanding/llava/train/train_mem.py \
    ...
    --version v1 \
    --data_path /public_data/jihai/data/multimodalout/smart_watch_train_120kg_180km.json \
    --image_folder /public_data/jihai/data/multimodalout/smart_watch_image_train_120kg_180km \
    --vision_tower google/siglip-base-patch16-224 \
    ...
    --bf16 True \
    --tf32 True \
    --output_dir ./checkpoints/llava-v1.5-7b-siglip-vq_120kg_180km-sw-lora \
    --num_ckpt_to_save 17 \
    --num_train_epochs 1 \
...
python eval_generate_smartwatch.py \
  ...
  --ckpt_step 45 \
  --ckpt_num 1 \
  --model_name "llava-v1.5-7b-siglip-vq_120kg_180km-sw-lora" 
