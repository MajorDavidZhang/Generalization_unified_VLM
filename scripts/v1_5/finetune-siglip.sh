...
deepspeed --master_port 29506 --include=localhost:0,1,2,3,4,5,6,7 /public_data/jihai/understanding/llava/train/train_mem.py \
    ...
    --pretrained_mm_mlp_adapter /public_data/jihai/understanding/scripts/v1_5/checkpoints/llava-v1.5-7b-clip-gen-detach-pretrain/mm_projector/checkpoint-2767.bin \
    ...
    --bf16 True \
    --tf32 True \
    --output_dir ./checkpoints/llava-v1.5-7b-clip-gen-detach \
    --num_ckpt_to_save 2 \
    --num_train_epochs 1 \
